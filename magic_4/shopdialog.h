...
public:
        ...
        : QDialog(parent)
    {
        ...
        QFont font("Arial",30);
        btnAttack = new QPushButton("被正态了，增加1点攻击力----20rmb");
        btnDefense = new QPushButton("和游客顶撞，增加1点防御力-----20rmb");
        btnHealth = new QPushButton("吃一口“偷火锅”，增加50点生命值-----20rmb");
        btnExit = new QPushButton("退出商店");
        levelup=new QPushButton("三相之力！增加1点攻击1点防御和50点生命----50rmb");
